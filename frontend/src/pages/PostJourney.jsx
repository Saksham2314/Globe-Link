  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-2">Share Your Journey</h1>
          <p className="text-purple-200">Tell the world about your amazing travel experience</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* File Upload */}
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
            <label className="text-sm font-medium text-purple-200 mb-4 block">Media Files (Images & Videos)</label>
            ...
            >
              ...
              <p className="text-purple-200/50 text-xs mt-4">Max 10 files, 10MB each</p>
              <p className="text-purple-200/50 text-xs">{files.length}/10 files selected</p>
            </div>

            {filePreviews.length > 0 && (
              <div className="mt-6">
                <h3 className="text-purple-200 font-medium mb-4">Selected Files ({filePreviews.length})</h3>
